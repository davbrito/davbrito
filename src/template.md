...
personal:
  ...
  - name: ComeRico
    ...
    tech: ["ASP.NET Core", SignalR, "TanStack Start", TypeScript]
  ...
  - name: Atelier
    ...
    tech: ["TanStack Start", "Cloudflare Workers", PostgreSQL, TypeScript]
  ...
  - name: minurl
    ...
    tech: ["Cloudflare Pages", "Cloudflare Workers KV", TypeScript]
...
Welcome to my GitHub! I have 5 years of experience building full-stack applications with React :react:, TypeScript :ts:, .NET/EF Core, and Node.js :node:, along with Deno :deno:, Next.js :nextjs:, Vite :vite: and PostCSS :postcss:.
