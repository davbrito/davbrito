...
export function renderRepoPinCard(repo: RepoData): string {
  const width = 400;
  const height = 125;
  ...
  const svg = render(
    ...
    >
      <style>{`
        .gh-repo { font: 600 14px 'Segoe UI', Ubuntu, Sans-Serif; fill: #58a6ff; }
        .gh-desc { font: 400 12px 'Segoe UI', Ubuntu, Sans-Serif; fill: #8b949e; }
        .gh-lang { font: 400 12px 'Segoe UI', Ubuntu, Sans-Serif; fill: #e6edf3; }
        .gh-stat { font: 400 12px 'Segoe UI', Ubuntu, Sans-Serif; fill: #8b949e; }
      `}</style>
      <rect
        width={width}
        height={height}
